...
export interface UserRequirements {
  ...
  language?: 'zh-CN' | 'en-US'; // Optional explicit language override for legacy/local flows
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US'; // Legacy/local language hint for downstream fallbacks
